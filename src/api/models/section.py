...
class Section(db.model):
    ...
    article_id = db.Column(db.Integer, nullable=False) # id of the article the section belongs to.

    def __init__(self, section_number, media_url, section_header, section_content, article_id):
